...
import PrerequisiteRequirementForm from "./components/PrerequisiteRequirementForm";
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        {/* TEMPORARY ROUTES */}
        <Route 
          path="/prereqandrequirements"
          element={<PrerequisiteRequirementForm majors={majors} setMajors={setMajors} />}
        />
        {/* Update route */}
      </Routes>
    </Router>
